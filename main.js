...
function start(){
    randNO = Math.floor((Math.random()*data_set.length)+1);
    draw_target = data_set[randNO];
    document.getElementById("target").innerHTML = "Target: " + draw_target;
    background("white");
    timer_check = true;
...
function draw() {
    ...
    red = document.getElementById("inputRed").value;
    green = document.getElementById("inputGreen").value;
    blue = document.getElementById("inputBlue").value;
    strokeWeight(10);
...
function checkSketch(){
    if(draw_target == sketch && accuracy>50){
       background("black");
       score = score + 1;
       time = 60;
       draw_target = "";
